...
# This script copies the most up-to-date model outputs from the "data" folder in the covid19sim repository to the "src/covid19canada/data" folder for this repository
